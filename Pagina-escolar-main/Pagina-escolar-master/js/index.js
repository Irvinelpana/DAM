...
document.addEventListener("DOMContentLoaded", () => {
  const carreras = [
    {
      nombre: "Ing. Tecnologías de la información",
      jefe: "Mtro. Juan Pérez",
      ubicacion: "Edificio A, planta baja",
      descripcion: "Carrera enfocada en desarrollo de software, redes y seguridad informática."
    },
    {
      nombre: "Ing. En animación y efectos visuales",
      jefe: "Mtra. Ana Gómez",
      ubicacion: "Edificio B, sala 3",
      descripcion: "Especializada en animación digital, diseño gráfico y producción audiovisual."
    },
    {
      nombre: "Ing. En biotecnologías",
      jefe: "Dr. Carlos Ruiz",
      ubicacion: "Edificio C, laboratorio 2",
      descripcion: "Aplicación de tecnologías biológicas en salud, agricultura e industria."
    },
    {
      nombre: "Ing. En datos e inteligencia artificial",
      jefe: "Mtro. Laura Martínez",
      ubicacion: "Edificio D, sala 5",
      descripcion: "Analiza y desarrolla soluciones de IA y ciencia de datos."
    },
    {
      nombre: "Ing. En manufactura avanzada",
      jefe: "Ing. Jorge Hernández",
      ubicacion: "Talleres, nave 1",
      descripcion: "Diseño y mejora de procesos de manufactura con tecnología avanzada."
    },
    {
      nombre: "Lic. En comercio internacional y aduanas",
      jefe: "Lic. María López",
      ubicacion: "Edificio E, planta alta",
      descripcion: "Carrera enfocada en relaciones comerciales internacionales y normativas aduanales."
    }
  ];

  function abrirModal(index) {
    const carrera = carreras[index];
    document.getElementById("nombreCarrera").innerText = carrera.nombre;
    document.getElementById("jefeCarrera").innerText = carrera.jefe;
    document.getElementById("ubicacionCarrera").innerText = carrera.ubicacion;
    document.getElementById("descripcionCarrera").innerText = carrera.descripcion;
    document.getElementById("modalCarrera").classList.remove("hidden");
  }

  function cerrarModal() {
    document.getElementById("modalCarrera").classList.add("hidden");
  }

  document.querySelectorAll(".carrera-item").forEach((el, index) => {
    el.addEventListener("click", () => abrirModal(index));
  });

  // Hacer que cerrarModal esté disponible globalmente
